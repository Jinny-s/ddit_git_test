		...
		<div class="card card-outline card-primary">
			...
			<div class="card-body">
				...
				<div class="register-card-body">
					<form name="orderForm" role="form" class="form-horizontal" action="order.do" method="post">
						...
						<div class="card-footer">
							<div class="col-sm-12 text-center">
								<span style="font-size: 1.5em;font-weight: bold;">주문금액 : 총 ${price * cart.qty} 원</span><br>
								<span style="font-size: 1.0em;font-weight: bold;">${cart.qty}개 * ${price}원</span>
							</div>
							<div class="row">
								<div class="col-sm-6">
						...
						<input type="hidden" name="totalprice" value="${cart.qty * price }">
